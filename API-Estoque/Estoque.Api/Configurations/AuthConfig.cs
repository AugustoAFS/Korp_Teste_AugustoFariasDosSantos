...
{
    public const string PoliticaDeEscrita = "escrita-de-produto";
    ...
    private static readonly string[] PerfisDeEscrita = ["Administrador", "Gerente"];
        ...
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAuthorization(options =>
        {
            ...
            options.AddPolicy(PoliticaDeEscrita, policy => policy
                .RequireAuthenticatedUser()
                .RequireRole(PerfisDeEscrita));
        });
